        ...
        <View style={styles.detailContainer}>
          <View style={styles.detailTagWrapper}>
            <View style={{flexDirection: 'row'}}>
              <Text style={[styles.detailTag,{backgroundColor: '#00D1DB',color: '#fff',fontWeight: 'bold'}]}>{this.props.cut || '-'}折</Text>
              <Text style={[styles.detailTag,{backgroundColor: '#d97888',color: '#fff',fontWeight: 'bold'}]}>{this.props.circ || '-'}</Text>
              <Text numberOfLines={1} style={[styles.detailAssetType,{backgroundColor: '#d94d90',color: '#fff',fontWeight: 'bold'}]}>{this.props.asset_type || '-'}</Text>
            </View>
